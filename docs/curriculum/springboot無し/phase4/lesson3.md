# Phase4 Lesson3: AttendanceControllerを追加して層分離を進める

## ロードマップ接続
- 対象: `springless-roadmap.md` の Phase4
- このLessonで増える機能: Serviceの生成と注入をAppConfigへ統一
...
- `App.java` に今回の差分を実装する: Serviceの生成と注入をAppConfigへ統一
...
## 5. ブラウザ確認シナリオ（合格条件）
- ControllerがRepositoryを直接newしない
