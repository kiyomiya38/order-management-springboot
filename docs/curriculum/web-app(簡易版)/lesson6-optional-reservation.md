# Lesson6 任意演習: 入力ルール強化（予約フォームアプリ）
...
- Lesson1〜Lesson5 を完了している
- このLessonは任意演習です。Spring Bootへ進むための必須範囲を終えた後に、日付・時刻入力と予約重複チェックを追加で練習します。
- Git Bash を使える
- JDK 17 がインストール済み
...
## 1. 作業フォルダ
作業場所（絶対パス）:
- `~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app`

Git Bash:
```bash
cd ~/order-management-springboot
mkdir -p practice/pre-springboot/step6-optional-reservation-form-app/static
cd ~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app
```
...
## 3. `App.java` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app/App.java`
...
## 4. `index.html` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app/static/index.html`
...
## 5. `styles.css` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app/static/styles.css`
...
## 6. `app.js` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step6-optional-reservation-form-app/static/app.js`
...
## 13. 次へ
- このLessonは任意演習です。未実施の必修範囲がある場合は [README.md](./README.md) の順序へ戻ります。
- Spring Bootへ進む前の確認として、最後に [bridge-to-springboot.md](./bridge-to-springboot.md) を読みます。
