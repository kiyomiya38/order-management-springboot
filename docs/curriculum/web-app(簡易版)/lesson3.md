...
## 1. 作業フォルダ
作業場所（絶対パス）:
- `~/order-management-springboot/practice/pre-springboot/step3-todo-lite`

Git Bash:
```bash
cd ~/order-management-springboot
mkdir -p practice/pre-springboot/step3-todo-lite/static
cd ~/order-management-springboot/practice/pre-springboot/step3-todo-lite
```
...
## 3. `App.java` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step3-todo-lite/App.java`
...
## 4. `index.html` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step3-todo-lite/static/index.html`
...
## 5. `styles.css` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step3-todo-lite/static/styles.css`
...
## 6. `app.js` を作成
作成ファイル:
- `~/order-management-springboot/practice/pre-springboot/step3-todo-lite/static/app.js`
...
## 13. 次へ
- 次は [lesson4.md](./lesson4.md) に進み、サーバー側バリデーション、集計API、クライアント側絞り込みを扱います。
- CRUDの流れに不安がある場合は、`GET /api/todos`、`POST /api/todos`、`PATCH /api/todos/{id}/toggle`、`DELETE /api/todos/{id}` の役割を口頭で説明してから進みます。
