# Phase3 Lesson4: Service/Repository をWebに接続する

## ロードマップ接続
- 対象: `springless-roadmap.md` の Phase3
- このLessonで増える機能: Controller分割（Home/Attendance）
...
- `App.java` に今回の差分を実装する: Controller分割（Home/Attendance）
