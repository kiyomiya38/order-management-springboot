# Phase6 Lesson2: Validatorクラスで検証を分離する

## ロードマップ接続
- 対象: `springless-roadmap.md` の Phase6
- このLessonで増える機能: Validatorクラスへ検証ロジック分離
...
- `App.java` に今回の差分を実装する: Validatorクラスへ検証ロジック分離
