...
services:
  app:
    ...
    environment:
      ...
      DB_URL: jdbc:h2:mem:orders;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE
      DB_USER: sa
      DB_PASSWORD: ""
```
...
docker run --rm -p 8080:8080 \
  -e APP_NAME=orders-container \
  -e LOG_LEVEL=INFO \
  -e SPRING_PROFILES_ACTIVE=prod \
  -e DB_URL="jdbc:h2:mem:orders;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE" \
  -e DB_USER=sa \
  -e DB_PASSWORD= \
